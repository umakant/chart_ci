...
<div class="container">
	<form  name="userForm" action="http://localhost:81/ci_blog/index.php/registration/user_register" method="post" accept-charset="utf-8" class="form-horizontal"  ng-submit="submitForm(userForm.$valid)" novalidate>
  ...
  <fieldset>
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
      <?php echo form_input(['name'=>'fname','class'=>'form-control','placeholder'=>'First Name','ng-model'=>'user.fname','value'=>set_value('fname')]); ?>
	  <p ng-show="userForm.fname.$invalid && !userForm.fname.$pristine" class="help-block">You name is required.</p>
      </div>
    </div>
      </div>
      <div class="col-lg-4">
    ...
    <div class="form-group">
      <div class="col-lg-10 col-lg-offset-2">
        <?php 
        	echo form_submit(['name'=>'submit','value'=>'Register','class'=>'btn btn-primary']);
        ?>
      </div>
    </div>
  </fieldset>
